...
package/%.xdc.inc package/%_BONC.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package BONC" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: .interfaces $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js BONC $@
...
.PHONY: release,BONC
ifeq (,$(MK_NOGENDEPS))
-include package/rel/BONC.zip.dep
endif
package/rel/BONC/BONC/package/package.rel.xml: package/package.bld.xml
package/rel/BONC/BONC/package/package.rel.xml: package/build.cfg
package/rel/BONC/BONC/package/package.rel.xml: package/package.xdc.inc
package/rel/BONC/BONC/package/package.rel.xml: package/package.cfg.xdc.inc
package/rel/BONC/BONC/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

BONC.zip: package/rel/BONC.xdc.inc package/rel/BONC/BONC/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELZIP,package/rel/BONC.xdc.inc,package/rel/BONC.zip.dep)


release release,BONC: all BONC.zip
clean:: .clean
	-$(RM) BONC.zip
	-$(RM) package/rel/BONC.xdc.inc
	-$(RM) package/rel/BONC.zip.dep
